...
const VerifyEmail = () => {
  ...
  return (
    <div className="bg-dark min-h-screen text-white flex justify-center items-center p-4">
      {loading && (
        <div
      ...
      {!loading && !isAuthenticated && (
        <Link
          to="/login"
          className="inline-flex items-center justify-center px-5 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg"
        >
          Login
          <svg
